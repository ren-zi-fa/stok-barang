...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-blue-500 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <hr>
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group hover:bg-green-400 dark:text-black dark:hover:bg-gray-700" aria-controls="drop-down-menu" data-collapse-toggle="drop-down-menu">
                ...
                <ul id="drop-down-menu" class="hidden py-2 space-y-2">
                    <li>
                    ...
                    <li>
                        <a href="./inputPenjualan.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-green-400 dark:text-black dark:hover:bg-gray-700">Input Data Penjualan</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="laporan.php"  class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-green-400 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Laporan jumlah stok</span>
                </a>
            </li>
            <li>
                <a href="laporanBarang.php"  class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-green-400 dark:hover:bg-gray-700 group">
                    <svg class="w-5 h-5 text-gray-800 dark:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                        <path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2ZM7 2h4v2H7V2ZM5 15a1 1 0 1 1 0-2 1 1 0 0 1 0 2Zm0-4a1 1 0 1 1 0-2 1 1 0 0 1 0 2Zm8 4H8a1 1 0 0 1 0-2h5a1 1 0 0 1 0 2Zm0-4H8a1 1 0 0 1 0-2h5a1 1 0 1 1 0 2Z" />
                    </svg>
                    <span class="flex-1 ms-3 whitespace-nowrap">Laporan Penjualan barang</span>
                </a>
            </li>
            <li >
